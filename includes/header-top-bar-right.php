		...
		echo '<div class="top_bar_right">';
			echo '<div class="top_bar_right_wrapper">';
				...
				if( $header_search == 'input' ){
					...
					echo '<a class="ubermenu-target ubermenu-item-layout-default ubermenu-item-layout-text_only" href="#" tabindex="0"><span class="ubermenu-target-title ubermenu-target-text">Ready For Business?</span></a>';
