...
jQuery(window).load(function(){
	...
	var left, padleft, padright, width;

	jQuery('#create_pdf').on('click',function(){
		left = sections[0].style.left;
		padleft = sections[0].style.paddingLeft;
		padright = sections[0].style.paddingRight;
		width = sections[0].style.width;
		console.log(left);
		...
		if (window.innerWidth > 1156){
			jQuery('#Content').width(1700);
			jQuery('body').width(1700);
			jQuery('.section_wrapper').css("max-width",'100%');
			sections.css("width",'');
			sections.css("padding-left",'');
			sections.css("padding-right",'');
			sections.css("left",'');
		}
	 	...
	 	getCanvas().then(function(canvas){
			...
			window.setTimeout(function(){
				if (window.innerWidth > 1156){
					...
					jQuery('body').width("");
					jQuery('.section_wrapper').css("max-width","");
					sections.css("width",width);
					sections.css("padding-left",padleft);
					sections.css("padding-right",padright);
