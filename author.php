...
$translate['404-text'] = mfn_opts_get('translate') ? mfn_opts_get('translate-404-text','Please check the entered address and try again <em>or</em>') : __('Please check the entered address and try again or ','betheme');
